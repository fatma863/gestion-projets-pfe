...
const sections = [
  {
    ...
    items: [
      { to: '/admin/dashboard', icon: LayoutDashboard, label: 'Tableau de bord', match: '/admin/dashboard' },
      { to: '/admin/users', icon: Users, label: 'Utilisateurs', match: '/admin/users' },
    ],
  },
  {
    label: 'Projets',
    items: [
      { to: '/admin/my-tasks', icon: ListTodo, label: 'Mes tâches', match: '/admin/my-tasks' },
      { to: '/admin/projects', icon: FolderKanban, label: 'Projets', match: '/admin/projects' },
      { to: '/admin/teams', icon: UsersRound, label: 'Équipes', match: '/admin/teams' },
      { to: '/admin/gantt', icon: CalendarRange, label: 'Gantt', match: '/admin/gantt' },
    ],
  },
  {
    label: 'Outils',
    items: [
      { to: '/admin/ai', icon: Sparkles, label: 'IA & Analytics', match: '/admin/ai' },
      { to: '/admin/notifications', icon: Bell, label: 'Notifications', match: '/admin/notifications' },
    ],
  },
];
        ...
        {!collapsed && (
          <div className="flex items-center gap-2 pl-1">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-slate-500 font-medium flex items-center gap-0.5"><Shield size={9} /> Admin</span>
            </div>
          </div>
        )}
        <button
